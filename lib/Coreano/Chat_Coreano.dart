...
class Chat_Coreano extends StatefulWidget {
  const Chat_Coreano({Key key}) : super(key: key);

  @override
  _ChatbotState createState() => _ChatbotState();
}

class _ChatbotState extends State<Chat_Coreano> {
  ...
  void _getMensagem(query)async{
    AuthGoogle authGoogle = await AuthGoogle(fileJson:"assets/koreanlanguage-ersh-554b45c9e6af.json").build();
