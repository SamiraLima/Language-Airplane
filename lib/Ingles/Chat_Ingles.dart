...
class Chat_Ingles extends StatefulWidget {
  const Chat_Ingles({Key key}) : super(key: key);

  @override
  _Chat_InglesState createState() => _Chat_InglesState();
}

class _Chat_InglesState extends State<Chat_Ingles> {
  ...
  void _getMensagem(query)async{
    AuthGoogle authGoogle = await AuthGoogle(fileJson:"assets/englishlanguage-ahkb-f33426fe7578.json").build();
